# FloAspectBar Deployment Script
...
# Configuration
$sourceFolder = Join-Path $PSScriptRoot "FloAspectBar"
$destinationFolder = Join-Path $WoWPath "FloAspectBar"
...
# Header
Write-Host "`nFloAspectBar Deployment Tool" -ForegroundColor $colorInfo
...
Write-Host "  3. Type /fab help to verify addon loaded" -ForegroundColor Gray
Write-Host ""
