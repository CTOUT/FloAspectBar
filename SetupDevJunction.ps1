# FloAspectBar - Development Junction Setup
...
Write-Host "FloAspectBar Development Junction Setup" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan

# Paths
$SourcePath = "$PSScriptRoot\FloAspectBar"  # Addon files are in subfolder
...
if (Test-Path $InterfaceAddOnsPath) {
    ...
    $TargetPath = "$InterfaceAddOnsPath\FloAspectBar"
    ...
    $TargetPath = "$WoWPath\FloAspectBar"
