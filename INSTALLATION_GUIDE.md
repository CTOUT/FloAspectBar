...
4. Copy the **inner** `FloAspectBar` folder to `Interface\AddOns\`
5. You should have: `Interface\AddOns\FloAspectBar\FloAspectBar.toc`

**From Git clone:**
1. The repository has the addon files in a subfolder
2. Copy `FloAspectBar\FloAspectBar\` to `Interface\AddOns\FloAspectBar\`
